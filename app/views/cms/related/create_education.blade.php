...
@section('content')
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">创建教育部链接</h2>

        {{ Form::open(array('action' => array('FriendlyController@storeEducation'), 'class' => 'form-horizontal')) }}

            <div class="form-group">
              <label for="name" class="col-sm-2 control-label">教育部链接</label>
              <div class="col-sm-6">
                <input type="text" class="form-control" name="name" placeholder="教育部链接">
              </div>
            </div>
